...
public static class TypeChart
{
    ...
    public static float GetEffectiveness(PokemonType atkMoveType, PokemonType defPokemonType)
    {
        if (atkMoveType == PokemonType.None || defPokemonType == PokemonType.None)
        {
            return 1;
        }

        int row = (int)atkMoveType-1;
        int col = (int)defPokemonType-1;
        
        Debug.Log("Row = " + atkMoveType);
        Debug.Log("Row Int = " + row);
        Debug.Log("Col = " + defPokemonType);
